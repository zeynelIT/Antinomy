...
class InfoJoueurTest {
	...
	void testExisteParadoxIndice() {
		...
		Carte[] mainIndice = {new Carte(indiceCarte, Couleur.BLEU, Symbole.CRANE),
				new Carte(indiceCarte, Couleur.ROUGE, Symbole.PAPIER),
				new Carte(indiceCarte, Couleur.VIOLET, Symbole.CHAMPIGNON),
		};
		
		testInfoJoueur.setMain(mainIndice);
		assertTrue(testInfoJoueur.existeParadox(Couleur.ROUGE));
