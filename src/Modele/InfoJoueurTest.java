...
//
///** <P> Vérifie le bon fonctionnement de la classe {@link InfoJoueur}. </P>
// * <P>Teste le changement de points, si il existe un Paradox, la somme des cartes en main et le déplacement du
// * sorcier.</P>
// *
// * <P> Les tests sont executés plusieurs fois pour couvrir le plus de cas possibles. </P>
// */
//
