...
//
///**<P> Vérifie le bon fonctionnement de la classe {@link Jeu}. </P>
// * <P> Teste divers cas de jeu comme les Paradox, Clashs et échanges de cartes. </P>
// * <P> Chaque test est exécuté (arbitrairement) 1000 fois pour couvrir le plus de cas possibles. </P>
// * */
//class JeuTest {
//
//	Jeu jeuTest;
